...
public class SorterTest
{
    ...
    public void checkOddEvenOrder() {
        ...
        int[] input3 = new int[]{1, 2, 4, 6, 3, 7, 16};
        int[] sorted3 = Sorter.sortOddAndEven(input3);
        Assert.assertArrayEquals(sorted3, new int[]{1, 3, 7, 2, 4, 6, 16});


        int[] input4 = new int[]{1, 2, 4, 3, 6, 16};
        int[] sorted4 = Sorter.sortOddAndEven(input4);
        Assert.assertArrayEquals(sorted4, new int[]{1, 3, 2, 4, 6, 16});


        int[] input5 = new int[]{2, 4, 6, 8, 1, 3, 5, 7};
        int[] sorted5 = Sorter.sortOddAndEven(input5);
        Assert.assertArrayEquals(sorted5, new int[]{1, 3, 5, 7, 2, 4, 6, 8});
